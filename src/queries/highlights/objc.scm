...
; C inheritance flattened above; captures adapted for RedVim.
...
(module_import "@import" @keyword.directive path: (identifier) @namespace)

((preproc_include
  _ @keyword.directive path: (_))
  (#any-of? @keyword.directive "#include" "#import"))
...
(struct_declarator (pointer_declarator declarator: (identifier) @property))
...
(version_number) @string.special @number
