; Adapted for RedVim from SeniorMars/tree-sitter-typst 1acd48c90d260bc9f8a99f903d3e2a8031bc7aae (MIT).
...
(heading) @heading.1.markdown
((heading marker: (heading_marker) @_heading_marker) @heading.1.markdown
  (#eq? @_heading_marker "="))
((heading marker: (heading_marker) @_heading_marker) @heading.2.markdown
  (#eq? @_heading_marker "=="))
((heading marker: (heading_marker) @_heading_marker) @heading.3.markdown
  (#eq? @_heading_marker "==="))
((heading marker: (heading_marker) @_heading_marker) @heading.4.markdown
  (#eq? @_heading_marker "===="))
((heading marker: (heading_marker) @_heading_marker) @heading.5.markdown
  (#eq? @_heading_marker "====="))
((heading marker: (heading_marker) @_heading_marker) @heading.6.markdown
  (#eq? @_heading_marker "======"))
(bullet_list_item marker: (bullet_list_marker) @punctuation.special)
(numbered_list_item marker: (numbered_list_marker) @punctuation.special)
(term_list_item marker: (term_list_marker) @punctuation.special)
(strong) @text.strong
(emphasis) @text.emphasis
(smart_quote) @string.escape
(shorthand) @string.escape
(escape) @string.escape
(linebreak) @string.escape
(bracketed_text ["[" "]"] @punctuation.bracket)
(automatic_link) @text.uri
(label) @constant
(reference) @text.reference
(reference "@" @punctuation.special)
(reference target: (identifier) @text.reference)

; Raw text and language tags
(raw
  (raw_delimiter) @punctuation.special)
(raw language: (raw_language) @constant)
(raw content: (raw_content) @string)
((raw
  (raw_delimiter) @_raw_delimiter
  !language
  content: (raw_content) @string)
...
(module_import alias: (identifier) @type)
