...
const EMBEDDED_CHANGELOG: &str = include_str!("../REDVIM_CHANGELOG.md");
const EMBEDDED_RELEASE_CAMPAIGN: &str = include_str!("../release/redvim-campaign.toml");
const REPOSITORY: &str = "astrohackerlabs/redvim";
...
mod tests {
    ...
    const CHANGELOG: &str = "# Changelog\n\n## [0.5.0](https://example.test/0.5)\n\n### Features\n\n- **editor:** New thing ([#2](https://github.com/astrohackerlabs/redvim/issues/2)) ([abcdef0](https://github.com/astrohackerlabs/redvim/commit/abcdef0123456789))\n\n### Bug Fixes\n\n- Fix old thing\n\n## [0.4.0](https://example.test/0.4)\n\n### Features\n\n- Previous thing\n\n## [0.3.0](https://example.test/0.3)\n\n### Features\n\n- Old thing\n";
    ...
    fn unavailable_embedded_versions_still_offer_a_release_link() {
        ...
        assert!(notes.markdown.contains("RedVim v0.9.0"));
    ...
    fn github_release_replaces_current_notes_and_keeps_skipped_versions() {
        ...
        let payload = serde_json::json!({
            ...
            "html_url": "https://github.com/astrohackerlabs/redvim/releases/tag/v0.5.0",
